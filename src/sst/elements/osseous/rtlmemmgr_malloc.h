...
#ifndef _H_rtl_MEM_MANAGER_MALLOC
#define _H_rtl_MEM_MANAGER_MALLOC
...
class rtlMemoryManagerMalloc : public rtlMemoryManagerCache {

    public:
        /* SST ELI */
        SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(rtlMemoryManagerMalloc, "rtl", "MemoryManagerMalloc", SST_ELI_ELEMENT_VERSION(1,0,0),
                "MLM memory manager which supports malloc/free in different memory pools", SST::rtlComponent::rtlMemoryManager)

#define rtl_MEMMGR_MALLOC_ELI_PARAMS rtl_ELI_MEMMGR_CACHE_PARAMS,\
...
#define rtl_MEMMGR_MALLOC_ELI_STATS rtl_ELI_MEMMGR_CACHE_STATS, \
        ...
        SST_ELI_DOCUMENT_PARAMS( rtl_MEMMGR_MALLOC_ELI_PARAMS )
        SST_ELI_DOCUMENT_STATISTICS( rtl_MEMMGR_MALLOC_ELI_STATS )


        /* rtlMemoryManagerMalloc */
        rtlMemoryManagerMalloc(ComponentId_t id, Params& params);
        ~rtlMemoryManagerMalloc();

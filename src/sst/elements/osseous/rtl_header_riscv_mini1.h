...
typedef struct ALUArea1 {

  ALUArea1() {
  }
} ALUArea1;

typedef struct ImmGenWire1 {

  ImmGenWire1() {
  }
} ImmGenWire1;

typedef struct BrCondArea1 {

  BrCondArea1() {
  }
} BrCondArea1;

typedef struct Datapath1 {
  UInt<32> fe_inst;
  UInt<33> fe_pc;
  UInt<32> ew_inst;
  UInt<33> ew_pc;
...
typedef struct Control1 {

  Control1() {
  }
} Control1;

typedef struct Core1 {
  Datapath dpath;
  Control ctrl;
...
class Rtlheader1: public mRtlComponentParent {
  public:
  FILE *RiscvMiniOut;
  UInt<1> clock;
  UInt<1> reset;
  ...
  Rtlheader1() {
    //RiscvMiniOut = fopen("RiscvMiniOut.txt", "w");
    reset.rand_init();
  ...
  void EVAL_25() {
    if (UNLIKELY(done_reset && update_registers && verbose && core$dpath$_T_301)) fprintf(RiscvMiniOut,"PC: %08" PRIx64 ", INST: %08" PRIx64 ", REG[%2" PRIu64 "] <- %08" PRIx64 "\n", core.dpath.ew_pc.as_single_word(), core.dpath.ew_inst.as_single_word(), core$dpath$_T_296.as_single_word(), core$dpath$_T_298.as_single_word());
  }
  void EVAL_26() {
    PARTflags[26] = false;
